# 3.5.1
## В файле [3.5.1.py](3.5.1.py) с помощью модуля sqllite3 и метода pandas.to_sql создана бд [proj.db](proj.db), таблица VALUTES и в нее помещены данные по курсам валют
