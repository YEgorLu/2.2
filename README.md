# 3.4.2
## С помощью пандас переписан функционал формирования статистика по годам и создания изображения графиков и pdf. Файлы: 3.4.2_pd_stats.py, [year_report.pdf](year_report.pdf)year_report.pdf, year_graph.png
